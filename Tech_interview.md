...
Sheduler - разпрелеляет приложения, назаначает рабочий узел каждому приложению
kube-control-manager - Контроллер узла (Node Controller): уведомляет и реагирует на сбои узла.
...
Guaranteed (Гарантированный) -  самый высокий приоритет и
Burstable (Гибкий) - Они более гибки, чем Guaranteed, и их могут удалить раньше,
Best-Effort (Лучший вариант) - имеют самый низкий приоритет и будут удалены первыми при нехватке ресурсов.
```
